...
def cheaper_properties(properties: list, reference: RealProperty):
    return [(property, property.price_difference(reference)) for property in properties if property.price_per_sqm * property.square_meters < reference.price_per_sqm * reference.square_meters]
